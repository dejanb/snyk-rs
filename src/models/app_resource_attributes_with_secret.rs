...
impl AppResourceAttributesWithSecret {
    pub fn new(access_token_ttl_seconds: f32, client_id: uuid::Uuid, client_secret: String, context: crate::models::Context, is_confidential: bool, is_public: bool, name: String, redirect_uris: Vec<String>, scopes: Vec<String>) -> AppResourceAttributesWithSecret {
